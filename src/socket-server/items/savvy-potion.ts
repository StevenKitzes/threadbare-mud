...
const id: ItemIds = ItemIds.SAVVY_POTION;
const type: ItemTypes = ItemTypes.consumable;
const title: string = "a wondrous, glittering golden potion";
const description: string = "A [glittering golden potion] in a long, thin vial, sparkling in the light.";
const keywords: string[] = ['glittering potion', 'golden potion', 'glittering golden potion'];
...
const handleItemCommand = (handlerOptions: HandlerOptions): boolean => {
  ...
  if (
    ...
    characterUpdate.savvy = character.savvy + 1;
    ...
    if (writeCharacterData(character.id, characterUpdate)) {
      ...
      emitSelf(`You gulp down ${title} and feel the Lifelight burning you up from the inside out.  When the feeling subsides, you feel your thoughts are a little clearer than before.`);
      return true;
    }
  }
