...
dbToHydrate.transaction(() => {
  ...
  hydrate(`
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);
  `, [
    adminCharacterId, adminId, adminCharacterName, testScene1Id, '1', '{"main":0}', '{}', '0', '["1"]'
  ]);
})();
...
dbToHydrate.transaction(() => {
  hydrate(`
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);
  `, [
    testCharacter1Id, testUserId, testCharacter1Name, testScene1Id, "1", '{"main":0}', "{}", "0", '["1"]'
  ]);
  hydrate(`
    INSERT INTO characters (id, user_id, name, scene_id, active, stories, scene_states, money, inventory)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);
  `, [
    testCharacter2Id, testUserId, testCharacter2Name, testScene1Id, "0", '{"main":0}', "{}", "0", '["1"]'
  ]);
  hydrate(`
    INSERT INTO characters (id, user_id, name, scene_id, active, stories, scene_states, money, inventory)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);
  `, [
    testCharacter3Id, testUserId, testCharacter3Name, testScene1Id, "0", '{"main":0}', "{}", "0", '["1"]'
  ]);
})();
